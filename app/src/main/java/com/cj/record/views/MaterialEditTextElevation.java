 ...
 */
public class MaterialEditTextElevation extends MaterialEditText {
    ...
    public MaterialEditTextElevation(Context context) {
        super(context);
        init(context);
    }

    public MaterialEditTextElevation(Context context, AttributeSet arg1) {
        super(context, arg1);
        init(context);
    }

    public MaterialEditTextElevation(Context context, AttributeSet arg1, int arg2) {
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(Drawable left, Drawable top, Drawable right, Drawable bottom) {
        Drawable dropdownIcon = ContextCompat.getDrawable(getContext(), R.mipmap.ic_meter_bold_black_24dp);
    ...
    public void setText(double d) {
        ...
        Editable editable = MaterialEditTextElevation.this.getText();
        if (d != 0.00) {
            if (isInit) {
                isInit = false;
                double mode = d - (int) d;
